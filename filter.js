function filterCategory(filterBy, buttonClicked){
    ...
    let itemsToFilter = Array.from(document.getElementsByClassName("BlogPost"));
    let itemsToFilter2 = Array.from(document.getElementsByClassName("Splash"));
    ...
    for(let listItem of itemsToFilter2){
